...
#define ELOOP_MSG_LEN       MSG_MAX_LEN
#define ELOOP_QUEUE_LEN   2
...
/**
 * recev_cb - msg queue callback func
 * @user_data: msg user struct
 * @msg_buf: msg queue data buf ptr (user_data)
 */
typedef int (*recev_cb)(void *user_data, char *msg_buf);
...
int eloop_register_signal_reconfig(eloop_signal_handler handler,
				   void *user_data);
/**
 * eloop_register_msg_q  - Register msg handler for msg queue
 * @msg_type: Register type user or driver
 * @user_data: Callback priv data
 * @cb: callback func
 * Returns: NULL failed; msg_q head is OK
 */
SCI_MSG_QUEUE_PTR  eloop_register_msg_q(enum msg_type msg_type,  void *user_data, recev_cb cb);

/**
 * eloop_unregister_msg_q  - Unregister msg handler for msg queue
 * @msg_type: msg type from user or driver
